...
def settings(request):
    ...
    return render(request, "HomeschoolTool/settings.html", {"recurringEvents": recurringEvents,
...
def calendar(request):
    return render(request, "HomeschoolTool/fullcalendar.html")
...
def postEvent(request, events, subjects, scheduleItemTypes, recurrenceTypes, students):
    if request.POST.get('selectStudent'):
        ...
        item = {
            ...
            'start': getDateTime(request, True, request.POST.get("createStartDate"), request.POST.get("createStartTime")),
